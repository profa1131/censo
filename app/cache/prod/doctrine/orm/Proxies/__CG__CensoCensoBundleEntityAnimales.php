 ...
 */
class Animales extends \Censo\CensoBundle\Entity\Animales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Animales' . "\0" . 'id', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Animales' . "\0" . 'nombre', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Animales' . "\0" . 'registroSocioeconomico');
        }
