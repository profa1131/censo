 ...
 */
class Comunas extends \Censo\CensoBundle\Entity\Comunas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Comunas' . "\0" . 'id', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Comunas' . "\0" . 'nombre', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Comunas' . "\0" . 'parroquia', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Comunas' . "\0" . 'direccion', '' . "\0" . 'Censo\\CensoBundle\\Entity\\Comunas' . "\0" . 'rif');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Comunas $proxy) {
