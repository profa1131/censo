...
use Censo\CensoBundle\Form\UsuariosType;
...
class UsuariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CensoBundle:Usuarios')->findAll();
     ...
     * @Method("POST")
     * @Template("CensoBundle:Usuarios:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CensoBundle:Usuarios:edit.html.twig")
     */
