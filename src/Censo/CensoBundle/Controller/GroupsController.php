...
use Censo\CensoBundle\Entity\Groups;
use Censo\CensoBundle\Form\GroupsType;
...
class GroupsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CensoBundle:Groups')->findAll();
     ...
     * @Method("POST")
     * @Template("CensoBundle:Groups:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CensoBundle:Groups')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CensoBundle:Groups:edit.html.twig")
     */
